export default function Home (){
  return <main className="h-screen w-full flex overflow-scroll">
    <div className="w-full h-full  pt-6 px-6 space-y-6">
      <div className="w-full h-auto space-x-4"> Test</div>
      <div className="w-full h-[200px]  bg-white rounded-3xl"> Test 2</div>
    ...
    <div className="w-[500px] h-full bg-white flex flex-col"></div>
  
  </main>
//   return(
//     <main className="h-screen w-full flex">
//       <div className="w-full h-full overflow-scroll pt-6 px-6 space-y-6">
//         <div className="w-full h-auto space-x-4">
//         </div>
//         {/* <div className="w-full h-[200px]  bg-white rounded-3xl"></div>
